...
const Footer = () => {
  return (
    <footer className="relative bg-[#004b87] text-white pt-16 pb-6 overflow-hidden mt-12 border-t-[6px] border-orange-500">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-3 mb-4">
              {/* Replace src with your actual transparent logo */}
              <img 
                src="/logo_pis.png" 
                alt="School Logo" 
          ...
          {/* Column 2: Quick Links (Added to make it fully fledged) */}
          <div>
            ...
            <ul className="space-y-3">
              {['About Us', 'Admissions', 'Academics', 'Gallery', 'Career', 'Contact Us'].map((link, index) => (
                <li key={index}>
                  <button className="text-blue-100 hover:text-orange-400 transition-all duration-300 flex items-center gap-2 group text-sm">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center gap-3">
                ...
                <a target="_blank" href="mailto:bsspisggn@gmail.com" className="text-blue-100 text-sm hover:text-orange-400 transition-colors underline-offset-4 hover:underline">
                  bsspisggn@gmail.com
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {/* Facebook */}
              <a target="_blank" href="https://www.facebook.com/PISGURUGRAM" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#1877F2] hover:-translate-y-1 transition-all duration-300 group">
              ...
              {/* Instagram */}
              <a target="_blank" href="https://www.instagram.com/pisgurugram/" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:-translate-y-1 transition-all duration-300 group">
              ...
              {/* YouTube */}
              <a target="_blank" href="https://www.youtube.com/@PISGURUGRAM" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FF0000] hover:-translate-y-1 transition-all duration-300 group">
        ...
        {/* Bottom Bar: Copyright & Visitors */}
        <div className="border-t border-blue-400/30 pt-6 pb-2 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-blue-100 text-xs md:text-sm text-center md:text-left">
            © Copyright 2026, all rights reserved with PRANAVANANDA INTERNATIONAL SCHOOL
          </p>
          
          <div className="flex gap-4 md:gap-8 text-xs md:text-sm font-medium">
            <div className="bg-blue-900/50 px-4 py-1.5 rounded-full border border-blue-400/20 shadow-inner">
              <span className="text-blue-200">Total Visitor No. :</span> <span className="text-orange-400">264748</span>
            </div>
            <div className="bg-blue-900/50 px-4 py-1.5 rounded-full border border-blue-400/20 shadow-inner">
              <span className="text-blue-200">Today's Visitor No. :</span> <span className="text-orange-400">190</span>
            </div>
          </div>
        </div>
