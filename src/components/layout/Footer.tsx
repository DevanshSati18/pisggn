...
const Footer = () => {
  // 2. Created an array of objects to map labels to their exact paths
  const quickLinks = [
    { label: 'About Us', path: '/about' },
    { label: 'Admissions', path: '/admission' },
    { label: 'Academics', path: '/academic' },
    { label: 'Gallery', path: '/gallery' },
    { label: 'Career', path: '/career' }, // Make sure to add this route to App.tsx later!
    ...
    <footer className="relative bg-[#004b87] text-white pt-16 pb-6 overflow-hidden mt-12 border-t-[6px] border-orange-500">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          {/* Column 2: Quick Links (Now Fully Functional) */}
          <div>
            ...
            <ul className="space-y-3">
              {/* 3. Replaced button with Link and mapped paths */}
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <Link 
                    to={link.path} 
                    className="text-blue-100 hover:text-orange-400 transition-all duration-300 flex items-center gap-2 group text-sm"
                  >
